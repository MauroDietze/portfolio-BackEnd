...
public class RegistrationRequest {
    ...
    @Schema(name = "A valid email",  requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "NonEmpty String")
    private String email;

    @NotNull(message = "Registration password cannot be null")
    @Schema(name = "A valid password string",  requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "NonEmpty String")
    private String password;

    @NotNull(message = "Specify whether the user has to be registered as an admin or not")
    @Schema(name = "Flag denoting whether the user is an admin or not",  requiredMode = Schema.RequiredMode.REQUIRED,
