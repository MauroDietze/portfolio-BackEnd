...
import com.Portfolio.event.OnGenerateResetLinkEvent;
import com.Portfolio.event.OnRegenerateEmailVerificationEvent;
import com.Portfolio.event.OnUserAccountChangeEvent;
import com.Portfolio.event.OnUserRegistrationCompleteEvent;
import com.Portfolio.exception.InvalidTokenRequestException;
import com.Portfolio.exception.PasswordResetException;
import com.Portfolio.exception.PasswordResetLinkException;
import com.Portfolio.exception.TokenRefreshException;
import com.Portfolio.exception.UserLoginException;
import com.Portfolio.exception.UserRegistrationException;
import com.Portfolio.model.CustomUserDetails;
import com.Portfolio.model.payload.ApiResponse;
import com.Portfolio.model.payload.JwtAuthenticationResponse;
import com.Portfolio.model.payload.LoginRequest;
import com.Portfolio.model.payload.PasswordResetLinkRequest;
import com.Portfolio.model.payload.PasswordResetRequest;
import com.Portfolio.model.payload.RegistrationRequest;
import com.Portfolio.model.payload.TokenRefreshRequest;
import com.Portfolio.model.token.EmailVerificationToken;
import com.Portfolio.model.token.RefreshToken;
...
@CrossOrigin(origins = "https://portfolio-frontend-mauro.web.app")
